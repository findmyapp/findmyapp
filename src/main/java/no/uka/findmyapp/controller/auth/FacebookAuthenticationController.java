...
{
	private static final String FACEBOOK_USER_DATA_URL = "https://graph.facebook.com/me?access_accessToken=";
	...
	public ModelAndView getUserId(@RequestParam(value="accessToken", required=true) String accessToken) {
		...
		String jsonTemp = "{ \"id\": \"772612305\", \"name\": \"Torstein M. Barkve\", \"first_name\": \"Torstein\", \"last_name\": 
							 \"M. Barkve\", \"link\": \"http://www.facebook.com/profile.php?id=772612305\", \"birthday\": \"05/10/1990\", 
							 \"education\": [ {\"school\": { \"id\": \"109956045693499\", \"name\": \"St. Svithun Videreg\u00e5ende Skole\" }, 
							 \"type\": \"High School\" }, { \"school\": { \"id\": \"109449622407837\", \"name\": \"Oslo University College\" }, 
							 \"year\": { \"id\": \"136328419721520\", \"name\": \"2009\" }, \"concentration\": [ {    \"id\": \"135775433156356\",    
							 \"name\": \"Anvendt datateknologi\" } ], \"type\": \"College\" } ], \"gender\": \"male\", \"timezone\": 2, \"locale\": 
							 \"nn_NO\", \"verified\": true, \"updated_time\": \"2011-06-06T12:18:15+0000\" }";
		...
		if(userdata.equals("Exception")) {
			return new ModelAndView("auth", "Error", userdata);
		}
		else {
			//data
		}
		
		return new ModelAndView("auth", "userid", userdata); 
	}
