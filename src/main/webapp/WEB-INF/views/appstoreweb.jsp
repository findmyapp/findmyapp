			         	...
			         	for(App myApp : applicationListI) {
			       		...
			       		"<tr>" +
			       			"<td width=\"71\" rowspan=\"3\">" +
			       				"<a href=\"? IOS-APPSTORE-URL ?" + myApp.getAndroidMarketUri() + "\">" +
			       				"<img src=\"../../appstoreweb-pictures/appicon-template.png\" width=\"71\" height=\"69\" />" +
			       			"</td>" +
			       			"<td class=\"utvikler\">Utvikler</td>" +
			       		"</tr>" +
			       		"<tr>" +
			       			"<td class=\"appnavn\"><a href= \"? IOS-APPSTORE-URL ?" + myApp.getAndroidMarketUri() + "\">" + myApp.getName() + "</td>" +
			       		"</tr>" +
			       		"<tr>" +
					...
					<td valign="top">
			          ...
			          List<App> applicationListA = androidList.getAppList();
			          	...
			          	for(App myApp : applicationListA) {
			        		...
			        		"</tr>" +
			        		"<tr>" +
			        			"<td class=\"appnavn\"><a href= \"http://market.android.com/details?id=" + myApp.getAndroidMarketUri() + "\">" + myApp.getName() + "</td>" +
			        		"</tr>" +
			        		"<tr>" +
			        			"<td class=\"rating\">* * * * * 102 ratings</td>" +
			        		"</tr>" +
